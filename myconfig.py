...
# TUB_PATH = "~/mycar/data/tub-" + DONKEY_GYM_ENV_NAME

# ============================================================
# DRIVE (keep in sync, not used at training but don't remove)
# ============================================================
# DRIVE_TRAIN_TYPE = "PWM_STEERING_THROTTLE"
# PWM_STEERING_THROTTLE = {
#     "PWM_STEERING_PIN":      "PCA9685.1:40.14",
...
#     "THROTTLE_FORWARD_PWM":  575,
#     "THROTTLE_STOPPED_PWM":  400,
#     "THROTTLE_REVERSE_PWM":  225,
# }
...
# # ============================================================
# # IMAGE — must match what was saved at collection time
# # ============================================================
# IMAGE_W     = 192
# IMAGE_H     = 224
# IMAGE_DEPTH = 3
...
# # ============================================================
# # TRANSFORMS — crop at training time since collection was raw
# # Start with Experiment 1 below, iterate from here
# # ============================================================
# TRANSFORMATIONS = ['CROP']
# ROI_CROP_TOP    = 60    # remove ceiling/background, ~27% of 224
# ROI_CROP_BOTTOM = 0
# ROI_CROP_LEFT   = 0
# ROI_CROP_RIGHT  = 0

# # ============================================================
# # AUGMENTATIONS — training only, teaches generalization
# # ============================================================
# AUGMENTATIONS        = ['BRIGHTNESS', 'BLUR']
# AUG_BRIGHTNESS_RANGE = 0.3    # handles uneven indoor lighting
# AUG_BLUR_RANGE       = 1      # mild, painted lines are sharp

# # ============================================================
# # MODEL
# # ============================================================
# DEFAULT_MODEL_TYPE  = 'linear'   # best for regression on steering+throttle
# BATCH_SIZE          = 64
# TRAIN_TEST_SPLIT    = 0.8        # 80% train, 20% val
# MAX_EPOCHS          = 100
# EARLY_STOP_PATIENCE = 10         # stops if val_loss doesn't improve for 5 epochs
...
# PWM_STEERING_THROTTLE = {
#     "PWM_STEERING_PIN": "PCA9685.1:40.4",
#     "PWM_STEERING_SCALE": 1.0,
#     "PWM_STEERING_INVERTED": False,
#     "STEERING_LEFT_PWM": 480,
#     "STEERING_RIGHT_PWM": 320,
...
#     "PWM_THROTTLE_SCALE": 1.0,
#     "PWM_THROTTLE_INVERTED": False,
#     "THROTTLE_FORWARD_PWM": 575,    # :white_check_mark: updated
#     "THROTTLE_STOPPED_PWM": 400,
#     "THROTTLE_REVERSE_PWM": 225,
# }
